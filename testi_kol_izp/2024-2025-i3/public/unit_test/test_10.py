...
expected = [i for i,j in [('5-Minute Crafts', 344.1), ('MrBeast', 199.0), ('Stokes Twins', 158.2)]]

actual = [i for i,j in naloge.ratio(slovar, "US")]

test_case.assertEqual(expected, actual, "Napacna imena kanalov.")