...
sez =  [('Robert Andrich', 'Germany', 30, 5, 0, 0, 2, 0),
...
test_case.assertEqual(act, exp, "Funkcija nad podatki iz datoteke z imenom EURO24_50.csv ne deluje pravilno.")
