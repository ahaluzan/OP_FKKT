...
actual = naloge.v_seznam("netflix_l.csv")
...
for expected1, actual1 in zip(expected,actual):
    test_case.assertEqual(type(expected1[4]), type(actual1[4]), "Zanri so neustreznega tipa.")
    test_case.assertEqual(expected1[4], actual1[4], "Zanr ni pravilen.")
