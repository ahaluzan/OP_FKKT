...
actual = naloge.binge_watching(sez, 1000)
expected = ['Pablo Escobar: The Drug Lord',
 'El Reemplazante',
...
test_case.assertEqual(len(actual), len(expected), "Preveri formulo za izracun dolzine.")
