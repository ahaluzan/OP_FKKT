...
actual = naloge.v_seznam("netflix_xl.csv")
expected = [('Pablo Escobar: The Drug Lord', 2012, 44, 10, 'crime', 'CO', 8.4, 'TV-14'),
 ...
 ('Lenox Hill', 2020, 48, 10, 'documentary', 'US', 8.6, 'ni_podano'),
 ...
 ('Mindhunter', 2017, 53, 20, 'drama', 'US', 8.6, 'ni_podano'),
 ...
 ('Top Gear', 2002, 58, 320, 'comedy', 'GB', 8.7, 'ni_podano'),
...
test_case.assertEqual(actual, expected, "Branje datoteke z imenom netflix_l.csv je napacno. Pazi na manjkajoce skupine!")
