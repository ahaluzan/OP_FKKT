...
expected = [i[5] for i in podatki]

actual = [i[5] for i in naloge.preberi_podatke("data/apps5.txt")]

test_case.assertEqual(len(expected), len(actual), "Neustrezno spremenjene letnice.")