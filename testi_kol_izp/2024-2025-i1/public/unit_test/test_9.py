...
expected = {'Madonna': 0.78, 'Coldplay': 0.56}

actual = naloge.tocke(podatki, ["Madonna", "Coldplay"])

test_case.assertEqual(list(expected.keys()), list(actual.keys()), "Napacni kljuci slovarja.")