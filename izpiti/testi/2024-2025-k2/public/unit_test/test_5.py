...
expected = {'Western Europe': [('Norway', 7.498), ('Finland', 7.413)], 'Central and Eastern Europe': [('Slovenia', 5.768), ('Turkmenistan', 5.658)], 'Latin America and Caribbean': [('Peru', 5.743)]}

actual = naloge.v_slovar(podatki1)

test_case.assertEqual(all(isinstance(v1, tuple) for v0 in expected.values() for v1 in v0), 
                      all(isinstance(v1, tuple) for v0 in actual.values() for v1 in v0),
                      "Napačna oblika podatkov v vrednostih.")
