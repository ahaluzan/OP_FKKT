...
expected = ['Right As Rain',
 'Hometown Glory',
 'From the Inside - Li...',
 'Lying from You - Liv...']

actual = naloge.izpis_skladb(podatki, 2008)

if len(expected) == len(actual):
    test_case.assertEqual(isinstance(expected, list), isinstance(actual, list), "Napacen podatkovni tip.")
else: 
    test_case.assertEqual(len(expected), len(actual), "Napacna dolzina seznama.")