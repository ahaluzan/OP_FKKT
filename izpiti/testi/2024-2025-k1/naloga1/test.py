    ...
    while True:
        ...
        if is_public == True: 
            if test_no == 1: 
                ...
                if len(stderr) > 0:
                ...
                elif "Geslo ni dovolj dolgo. Poskusite ponovno." in stdout:
                    tests_passed += 1
                    if color == None:
                        print('OK')
                    else:
                    ...
                    if color == None:
                        print('Neustrezen pogoj za preverjanje dolzine gesla.\n', 'ERROR') 
                    else:
                        st = color.write('Neustrezen pogoj za preverjanje dolzine gesla.\n', "ERROR") 
                ...
                if len(stderr) > 0:
                ...
                elif "Geslo ne vsebuje številk. Poskusite ponovno." in stdout:
                    tests_passed += 1
                    if color == None:
                        print('OK')
                    else:
                    ...
                    if color == None:
                        print('Preverjanje prisotnosti stevil manjka oz. je napacno.\n', 'ERROR') 
                    else:
                        st = color.write('Preverjanje prisotnosti stevil manjka oz. je napacno.\n', "ERROR") 
                ...
                if len(stderr) > 0:
                ...
                elif "Geslo ne vsebuje posebnega znaka. Poskusite ponovno." in stdout:
                    tests_passed += 1
                    if color == None:
                        print('OK')
                    else:
                    ...
                    if color == None:
                        print('Preverjanje prisotnosti posebnih znakov manjka oz. je napacno.\n', 'ERROR') 
                    else:
                        st = color.write('Preverjanje prisotnosti posebnih znakov manjka oz. je napacno.\n', "ERROR") 
